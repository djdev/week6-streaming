...
public class JsonKStreamJoins {
    ...
    public JsonKStreamJoins() {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "kafka_tutorial.kstream.count.plocation.v1-KSTREAM-AGGREGATE-STATE-STORE-0000000001-changelog");
    ...
    public Topology createTopology() {
        ...
        joined.filter(((key, value) -> value.isPresent())).mapValues(Optional::get).to(Topics.OUTPUT_TOPIC, Produced.with(Serdes.String(), CustomSerdes.getSerde(VendorInfo.class)));
